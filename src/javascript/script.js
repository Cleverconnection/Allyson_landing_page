$(document).ready(function() {
    ...
    const services = {
        button1: {
            ...
            description: "Serviço de cabeamento estruturado para empresas e residências, garantindo qualidade e organização.",
            activities: [
    ...
    let autoSwitchEnabled = true; // Variável de controle para o ciclo automático
